...
// TASK functions
let url = 'https://todoapplicationajax.herokuapp.com/api/task/'
let list_snapshot = [];
let activeItem = null;
    ...
    fetch(url, options)
        ...
        .then((data) => {
            ...
            for (let i in list) {
                ...
                let taskCompleted = document.getElementsByClassName('task-completed')[i];
...
form.addEventListener('submit', (e) => {
    e.preventDefault();
    let url = 'https://todoapplicationajax.herokuapp.com/api/taskcreate/';
    if (activeItem != null) {
        url = `https://todoapplicationajax.herokuapp.com/api/taskupdate/${activeItem.id}`;
        activeItem = null;
    }
...
const deleteBtn = (item) => {
    let url = `https://todoapplicationajax.herokuapp.com/api/taskdelete/${item.id}`
    let options = {
        method: 'DELETE',
        headers: {
            'Content-type': 'application/json',
...
const taskComplete = (item) => {
    ...
    let url = `https://todoapplicationajax.herokuapp.com/api/taskupdate/${item.id}`
    let data = {
        title: item.title,
